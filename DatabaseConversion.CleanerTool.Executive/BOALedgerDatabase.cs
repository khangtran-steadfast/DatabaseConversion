...
namespace DataConversionTool
{
    class BOALedgerDatabase : DestinationDatabase
    {
        ...
        /// Default constructor
        /// </summary>
        public BOALedgerDatabase() : base(typeof(DatabaseConversion.CleanerTool.BOALedgerDataAccess.BOALedgerEntities))
        {
            //
            ...
            try
            {
                this._dbContext = new DatabaseConversion.CleanerTool.BOALedgerDataAccess.BOALedgerEntities();
            }
        ...
        {
            return new DatabaseConversion.CleanerTool.BOALedgerDataAccess.BOALedgerEntities();
        }
        ...
        public void GenerateAutoMapperConfiguration(string filePath)
        {
            ...
            string mainTemplate = "Mapper.CreateMap<DatabaseConversion.CleanerTool.EclipseDataAccess.{TABLE}, DatabaseConversion.CleanerTool.BOALedgerDataAccess.{TABLE}>().ConvertUsing(CustomMapper_{TABLE})";
        ...
        public void GenerateCustomMapperFunction(string filePath)
        {
            ...
            string TEMPLATE = @"
                    ...
                    /// <returns></returns>
		            protected DatabaseConversion.CleanerTool.BOALedgerDataAccess.{TABLE} CustomMapper_{TABLE}(DatabaseConversion.CleanerTool.EclipseDataAccess.{TABLE} source)
                    {
                        //
                        // Initialize result
                        DatabaseConversion.CleanerTool.BOALedgerDataAccess.{TABLE} destination = new DatabaseConversion.CleanerTool.BOALedgerDataAccess.{TABLE}();
                        //
