...
namespace DatabaseConversion.CleanerTool.Executive.ManualMappingTable
{
    public class ManualMapping_task_documents : ManualMapping
    {
        ...
        public override void BeforeRunningAutoMapper(MappingManager manager, SourceDatabase sourceDatabase, DestinationDatabase destinationDatabase, object obj)
        {
            //
            // Cast type
            DatabaseConversion.CleanerTool.EclipseDataAccess.task_documents record = obj as DatabaseConversion.CleanerTool.EclipseDataAccess.task_documents;
        ...
        {
            DatabaseConversion.CleanerTool.BOALedgerDataAccess.task_documents record = obj as DatabaseConversion.CleanerTool.BOALedgerDataAccess.task_documents;
