...
using DatabaseConversion.CleanerTool.Executive.ManualMappingTable;
...
namespace DatabaseConversion.CleanerTool.Executive
{
    class Program
    {
        ...
        private static void ConfigurePostMigrationScript(MappingManager manager)
        {
            ...
            manager.AddPostMigrationScript(@"SQLScript\3.2.1.CreatePolicyRecord.sql");
            manager.AddPostMigrationScript(@"SQLScript\3.2.2.UpdatePoliciesTable.sql");
            manager.AddPostMigrationScript(@"SQLScript\3.2.3.PopulateCurrentPolicy.sql");
            manager.AddPostMigrationScript(@"SQLScript\3.2.4.UpdateJournalsTable.sql");
            manager.AddPostMigrationScript(@"SQLScript\3.2.5.UpdateWorkbook_NotesTable.sql");
            ...
            manager.AddPostMigrationScript(@"SQLScript\4.4.AutoPolicyNumber.sql");
            manager.AddPostMigrationScript(@"SQLScript\4.5.EditBrokerRepWorkbook.sql");
            manager.AddPostMigrationScript(@"SQLScript\4.6.MandatoryFields.sql");
        }
