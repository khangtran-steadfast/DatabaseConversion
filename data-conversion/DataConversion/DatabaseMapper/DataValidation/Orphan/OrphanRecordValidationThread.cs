    ...
    public class OrphanRecordValidationThread
    {
        ...
        private bool IsValid(object record)
        {
            ...
            foreach (ReferenceInformation reference in this._listReferences)
            {
                ...
                {
                    LogService.Log.Error("Foreign key constraint is violated. Reference from " +
                                         reference.FKTableName + " ( " + reference.FKColumnName + " ) to " + 
                                         reference.PKTableName + " ( " + reference.PKColumnName + " )");
                    result = false;
                    break;
                }
            }
