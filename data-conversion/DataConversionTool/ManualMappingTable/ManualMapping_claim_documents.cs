...
namespace DataConversionTool.ManualMappingTable
{
    public class ManualMapping_claim_documents : ManualMapping
    {
        ...
        public override void BeforeRunningAutoMapper(MappingManager manager, SourceDatabase sourceDatabase, DestinationDatabase destinationDatabase, object obj)
        {
            //
            // Cast type
            EclipseDataAccess.claim_documents record = obj as EclipseDataAccess.claim_documents;
        ...
        {
            BOALedgerDataAccess.claim_documents record = obj as BOALedgerDataAccess.claim_documents;
