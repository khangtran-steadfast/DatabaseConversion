...
namespace DataConversionTool.ManualMappingTable
{
    public class ManualMapping_claim_sub_tasks : ManualMapping
    {
        ...
        public override void BeforeRunningAutoMapper(MappingManager manager, SourceDatabase sourceDatabase, DestinationDatabase destinationDatabase, object obj)
        {
            //
            // Cast type
            EclipseDataAccess.claim_sub_tasks record = obj as EclipseDataAccess.claim_sub_tasks;
        ...
        {
            BOALedgerDataAccess.claim_sub_tasks record = obj as BOALedgerDataAccess.claim_sub_tasks;
