...
namespace DataConversionTool.ManualMappingTable
{
    public class ManualMapping_confirmation_of_cover : ManualMapping
    {
        ...
        public override void BeforeRunningAutoMapper(MappingManager manager, SourceDatabase sourceDatabase, DestinationDatabase destinationDatabase, object obj)
        {
            //
            // Cast type
            EclipseDataAccess.confirmation_of_cover record = obj as EclipseDataAccess.confirmation_of_cover;
        ...
        {
            BOALedgerDataAccess.confirmation_of_cover record = obj as BOALedgerDataAccess.confirmation_of_cover;
