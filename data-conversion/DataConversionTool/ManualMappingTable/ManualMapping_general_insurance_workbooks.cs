...
namespace DataConversionTool.ManualMappingTable
{
    public class ManualMapping_general_insurance_workbooks : ManualMapping
    {
        ...
        public override void BeforeRunningAutoMapper(MappingManager manager, SourceDatabase sourceDatabase, DestinationDatabase destinationDatabase, object obj)
        {
            //
            // Cast type
            EclipseDataAccess.general_insurance_workbooks record = obj as EclipseDataAccess.general_insurance_workbooks;
        ...
        {
            BOALedgerDataAccess.general_insurance_workbooks record = obj as BOALedgerDataAccess.general_insurance_workbooks;
