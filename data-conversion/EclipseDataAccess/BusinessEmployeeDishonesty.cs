...
namespace EclipseDataAccess
{
    ...
    public partial class BusinessEmployeeDishonesty
    {
        public int BusinessEmployeeDishonestyId { get; set; }
        public int WorkbookId { get; set; }
        public Nullable<decimal> LimitEmployee { get; set; }
        public Nullable<decimal> LimitPeriod { get; set; }
